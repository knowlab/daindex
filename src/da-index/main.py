...
class Core(object):
    ...
    def deterioration_index(
        ...
        kde, fitted_bandwith = Core.kde_estimate(
            X, bandwidth=bandwidth, kernel=kernel, search_bandwidth=search_bandwidth
        )
...
class Util(object):
    ...
    def compare_two_groups(
        ...
        c1_di = Core.deterioration_index(
            X1,
            min_v,
            max_v,
            reverse=reverse,
        ...
        c2_di = Core.deterioration_index(
            X2,
            min_v,
            max_v,
            reverse=reverse,
